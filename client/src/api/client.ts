...
export const mapsApi = {
  ...
  details: (placeId: string, lang?: string, options?: { expand?: boolean; refresh?: boolean }) =>
    apiClient.get(`/maps/details/${encodeURIComponent(placeId)}`, {
      params: { lang, expand: options?.expand ? '1' : undefined, refresh: options?.refresh ? '1' : undefined },
